...
contract CreateSubscription is Script {
    ...
    function createSubscription(
        ...
        console2.log("Please update the subscription ID in the config file.");
...
contract FundSubscription is Script, CodeConstants {
    ...
    function fundSubscription(
        ...
        console2.log("Using LINK token:", linkToken);
...
contract AddConsumer is Script {
    ...
    function addConsumer(
        ...
        console2.log("Adding consumer to VRF subscription");
        console2.log("Contract to add:", contractToAddToVrf);
